...
namespace EF.FirstCodeLib.DAL.Migrations
{
    ...
    [Migration("20220427193113_AuthorConfig")]
            ...
            modelBuilder.Entity("EF.FirstCodeLib.DAL.Entities.Author", b =>
                {
                    ...
                    b.Property<DateTime>("AuthorCreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 27, 22, 31, 12, 853, DateTimeKind.Local).AddTicks(9043));
            ...
            modelBuilder.Entity("EF.FirstCodeLib.DAL.Entities.Book", b =>
                {
                    ...
                    b.Property<DateTime>("BookCreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 27, 22, 31, 12, 866, DateTimeKind.Local).AddTicks(4495));
