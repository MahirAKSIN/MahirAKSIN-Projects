...
namespace EF.FirstCodeLib.DAL.Migrations
{
    ...
    [Migration("20220427193214_RelationsAdd")]
            ...
            modelBuilder.Entity("EF.FirstCodeLib.DAL.Entities.Author", b =>
                {
                    ...
                    b.Property<DateTime>("AuthorCreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 27, 22, 32, 13, 887, DateTimeKind.Local).AddTicks(6314));
            ...
            modelBuilder.Entity("EF.FirstCodeLib.DAL.Entities.Book", b =>
                {
                    ...
                    b.Property<DateTime>("BookCreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 27, 22, 32, 13, 900, DateTimeKind.Local).AddTicks(863));
